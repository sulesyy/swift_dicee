A simple dice-rolling app built with Swift and Xcode. Inspired by the "Dicee" project from the App Brewery iOS Development Bootcamp. It displays two dice that generate random numbers on each roll.
